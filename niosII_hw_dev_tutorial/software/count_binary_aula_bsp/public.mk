...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../nios2_quartus2_project.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x11040
SOPC_SYSID_FLAG += --sidp=0x11040
ELF_PATCH_FLAG  += --sidp 0x11040

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1575057530
SOPC_SYSID_FLAG += --timestamp=1575057530
ELF_PATCH_FLAG  += --timestamp 1575057530
